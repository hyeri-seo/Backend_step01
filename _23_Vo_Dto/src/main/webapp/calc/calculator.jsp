<!-- page 지시자
원래 jsp를 다른 언어도 지원하려고 했으나, 워낙 빠른 기술의 빠른 발달로 다른 Web방식도 나오니까
